...
function SoundManager(smURL, smID) {
 ...
 // this.useHTML5Audio = true;         // use HTML5 Audio() where API is supported (most Safari, Chrome versions), Firefox (no MP3/MP4.) Ideally, transparent vs. Flash API where possible.
    this.useHTML5Audio =  false;         // use HTML5 Audio() where API is supported (most Safari, Chrome versions), Firefox (no MP3/MP4.) Ideally, transparent vs. Flash API where possible. - KN changing this to so iPad uses flash
  ...
  _createMovie = function(smID, smURL) {
    ...
    if (_isIE) {
      ...
      movieHTML = [
        '<object id="' + smID + '" data="../../../../Copy of window/javascripts/soundManager2/script/' + smURL + '" type="' + oEmbed.type + '" title="' + oEmbed.title +'" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="../../../../Copy of window/javascripts/soundManager2/script/' + _http+'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0" width="' + oEmbed.width + '" height="' + oEmbed.height + '">',
        param('movie', smURL),
